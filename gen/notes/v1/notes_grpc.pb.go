...
const (
	NoteService_ListNotes_FullMethodName      = "/proto.notes.v1.NoteService/ListNotes"
	NoteService_GetNote_FullMethodName        = "/proto.notes.v1.NoteService/GetNote"
	NoteService_CreateNote_FullMethodName     = "/proto.notes.v1.NoteService/CreateNote"
	NoteService_DeleteNote_FullMethodName     = "/proto.notes.v1.NoteService/DeleteNote"
	NoteService_DeleteAllNotes_FullMethodName = "/proto.notes.v1.NoteService/DeleteAllNotes"
	NoteService_WatchNotes_FullMethodName     = "/proto.notes.v1.NoteService/WatchNotes"
)
...
type NoteServiceClient interface {
	...
	DeleteAllNotes(ctx context.Context, in *DeleteAllNotesRequest, opts ...grpc.CallOption) (*DeleteAllNotesResponse, error)
...
func (c *noteServiceClient) DeleteAllNotes(ctx context.Context, in *DeleteAllNotesRequest, opts ...grpc.CallOption) (*DeleteAllNotesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteAllNotesResponse)
	err := c.cc.Invoke(ctx, NoteService_DeleteAllNotes_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NoteServiceServer interface {
	...
	DeleteAllNotes(context.Context, *DeleteAllNotesRequest) (*DeleteAllNotesResponse, error)
...
func (UnimplementedNoteServiceServer) DeleteAllNotes(context.Context, *DeleteAllNotesRequest) (*DeleteAllNotesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method DeleteAllNotes not implemented")
}
...
func _NoteService_DeleteAllNotes_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteAllNotesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NoteServiceServer).DeleteAllNotes(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NoteService_DeleteAllNotes_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NoteServiceServer).DeleteAllNotes(ctx, req.(*DeleteAllNotesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NoteService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.notes.v1.NoteService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteAllNotes",
			Handler:    _NoteService_DeleteAllNotes_Handler,
		},
	},
